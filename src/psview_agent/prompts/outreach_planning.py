...
def build_outreach_planning_prompts(
    *,
    ...
    system_prompt = (
        ...
        "concise, candidate-specific, and ask at most one question. The initial message should "
        "be three to four concise sentences: a personalized opener, a role or job-description "
        ...
        "thoughtful recruiter, not a sequence template. "
