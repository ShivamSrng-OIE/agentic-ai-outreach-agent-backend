...
def default_settings_dict() -> dict[str, object]:
    ...
    return {
        ...
        "model": {
            ...
            "general_chat_model_name": "google/gemma-4-31b-it:free",
            "structured_json_model_name": "nex-agi/nex-n2-pro:free",
            "coding_backend_model_name": "cohere/north-mini-code:free",
